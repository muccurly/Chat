...
namespace SoilesuX.Helpers
{
    ...
    public static class RTLHelper
    {
        ...
        {
            if (!(bindable is Xamarin.Forms.View view)) return;
        ...
        private static void UpdateMargin(VisualElement view)
        {
            ...
            if (margin != ZeroThickness)
            {
                ...
                view.SetValue(Xamarin.Forms.View.MarginProperty, margin);
            }
            else
            {
                view.ClearValue(Xamarin.Forms.View.MarginProperty);
            }
        }
        ...
        private static void UpdatePadding(Xamarin.Forms.View layout)
        {
        ...
        /// </summary>
        /// <param name="view">The view</param>
        private static void UpdateCornerRadius(Xamarin.Forms.View view)
        {
            var controller = (IVisualElementController)view;
        ...
        {
            if (sender is Xamarin.Forms.View view)
            {
        ...
        private static void OnElementAttached(Xamarin.Forms.View element)
        {
        ...
        /// </summary>
        /// <param name="element">The view</param>
        private static void OnElementDetached(Xamarin.Forms.View element)
        {
            element.PropertyChanged -= OnElementPropertyChanged;
        }
